        ...
        {({ loading, error, data }) => {
          ...
          return (
            <React.Fragment>
              {
                stores.map(s =>
                  <li key={s.store_id} ><Link to={{ pathname: "/" }}><i className={s.fa_icon}></i>{s.description}<span>40</span></Link></li>
                )
              }
            </React.Fragment>
          )
      ...
      <React.Fragment>
        <div className="page-container ptb-60">
          <div className="container">
            <section className="stores-area stores-area-v2">
              <h3 className="mb-40 t-uppercase">View Deals by stores</h3>
              <div className="letters-toolbar p-10 panel mb-40">
                <span className="all-stores"><a href="#.">All stores</a></span>
              ...
              <div className="stores-cat panel mb-40">
                <h3 className="stores-cat-header">A</h3>
                <ul className="row stores-cat-body">
              ...
              <div className="stores-cat panel mb-40">
                <h3 className="stores-cat-header">B</h3>
                <ul className="row stores-cat-body">
                  <li className="col-sm-4">
                    <ul>
              ...
              <div className="stores-cat panel mb-40">
                <h3 className="stores-cat-header">C</h3>
                <ul className="row stores-cat-body">
                  <li className="col-sm-4">
                    <ul>
