                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="404.html"><i class="fa fa-flag-en"></i>English</a>
                                        </li>
                                        <li><a href="./ar/404.html"><i class="fa fa-flag-ar"></i>العربية</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                ...
                <div class="container">
                    <nav class="nav-bar">
                        ...
                        <div class="nav-menu nav-menu-fixed">
                            <a href="./ar/404.html" target="_blank">RTL VERSION<i class="fa fa-long-arrow-right ml-10"></i></a>
                        </div>
                    </nav>
                </div>
            </div>
                    ...
                    <section class="error-page-area">
                        <div class="container">
                            <div class="error-page-wrapper t-center">
                                ...
                                <a href="index-2.html" class="btn btn-rounded">Back to home page</a>
                            </div>
                        </div>
                    </section>
                </div>
